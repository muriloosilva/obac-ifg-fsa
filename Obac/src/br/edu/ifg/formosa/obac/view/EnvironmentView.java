...
public class EnvironmentView extends JPanel{
	...
	public static String terraQuedaLivreAberto = "terraquedalivreaberto.png";
	public static String terraQuedaLivreFechado = "terraquedalivrefechado.png";
	...
	public static String luaQuedaLivreAberto = "luaquedalivreaberto.png";
	public static String luaQuedaLivreFechado = "luaquedalivrefechado.png";
	...
	public static String marteQuedaLivreAberto = "martequedalivreaberto.png";
	public static String marteQuedaLivreFechado = "martequedalivrefechado.png";
